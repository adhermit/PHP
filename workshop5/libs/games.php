...
function getGames(): array
{
    $games = [
        ...
        ["name" => 'Call break', "editor" => "Activision", "description" => "Call of Duty is a first-person shooter series that spans various war scenarios, from historical World War II settings to futuristic battles."],
    ];
